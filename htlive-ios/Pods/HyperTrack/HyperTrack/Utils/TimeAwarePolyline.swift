...
public func timedCoordinatesFrom(polyline: String, precision: Double = 1e5) -> [TimedCoordinates]? {
...
public func timeAwarePolylineFrom(_ timedCoordinates: [TimedCoordinates], precision: Double = 1e5) -> String {
