 ...
 */
open class HTScalingCarouselView: UICollectionView {
    ...
    public convenience init(withFrame frame: CGRect, andInset inset: CGFloat) {
        self.init(frame: frame, collectionViewLayout: HTScalingCarouselLayout(withCarouselInset: inset))
...
private typealias PrivateAPI = HTScalingCarouselView
fileprivate extension PrivateAPI {
    ...
    fileprivate func configureLayout() {
        ...
        collectionViewLayout = HTScalingCarouselLayout(
 ...
 */
private typealias InvisibleScrollDelegate = HTScalingCarouselView
